...
export const SORT_COUNTRY_SUCCESS = 'SORT_COUNTRY_SUCCESS';
export const SORT_COUNTRY_FAILED = 'SORT_COUNTRY_FAILED';

export const SORT_STATUS = 'SORT_STATUS';
export const SORT_STATUS_SUCCESS = 'SORT_STATUS_SUCCESS';
export const SORT_STATUS_FAILED = 'SORT_STATUS_FAILED';